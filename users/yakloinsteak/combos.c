...
const uint16_t PROGMEM snippets_combo[] = {KC_Q, KC_E, COMBO_END};
const uint16_t PROGMEM ctrla_combo[] = {KC_Q, KC_R, COMBO_END};
const uint16_t PROGMEM tmux_window_switch_combo[] = {KC_Q, KC_T, COMBO_END};
