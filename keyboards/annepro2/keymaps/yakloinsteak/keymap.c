...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,  KC_LGUI, MO(LTHUMB_2R),                   KC_SPC,       MO(RTHUMB_2L), MO(MACROS), MO(UTIL), KC_NO
),
  /*
  * tab hold
  * ,-----------------------------------------------------------------------------------------.
 ...
 [LTHUMB_2R] = LAYOUT_60_ansi(
    ...
    _______,          XXXXXXX, YL_WRPC, MS_ACL1, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, _______,                                     DBLCLK,                    _______, XXXXXXX, XXXXXXX, _______
 ),

 [RTHUMB_2L] = LAYOUT_60_ansi(
